...
<head>
  ...
  <title>Sisformasi Film | Ubah Data Film</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ubah Data Film</h1>
          </div>
        </div>
                ...
                <div class="card-body">
                  <form action="/editfilm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="id" value="{{ $d->id }}" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="mb-3">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="tipe1" value="Movie">
                        <label class="form-check-label" for="flexRadioDefault1">
                          Movie
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="tipe2" value="Series">
                        <label class="form-check-label" for="flexRadioDefault1">
                          Series
                        </label>
                      </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="genre" value="{{ $d->genre }}" class="form-control"
                        id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Trailer</label>
                      <div class="input-group">
                        <video src="{{ Storage::url($d->trailer) }}" controls="controls" width="500"></video>
                      </div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Poster</label>
                      <div class="input-group">
                        <img src="{{ Storage::url($d->poster) }}" height="500" alt="">
                      </div>
                    </div>
