...
<head>
  ...
  <title>Sisformasi Film | Data Film</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="/searchfilm" class="form-inline" method="GET">
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                @foreach($daftarfilm as $d)
                <tr>
                  <td>{{ $d->id }}</td>
                  <td>{{ $d->judul }}</td>
                  <td>{{ $d->type }}</td>
                  <td>{{ $d->genre }}</td>
                  <td><video src="{{ Storage::url($d->trailer) }}" width="200"
                          controls="controls"></video></td>
                  <td><img src="{{ Storage::url($d->poster) }}" alt="" width="50"></td>
                  <td>
                  <a href="/showfilm/{{ $d->id }}"><button type="button" class="btn btn-primary btn-sm">Edit</button>
                  <a href="#"><button type="button" class="btn btn-danger btn-sm delete" data-nama="{{ $d->judul }}"
          ...
          <a href="/tambahfilm" type="button" class="btn btn-success">Tambah Data</a>
          <!-- INI KONTEN NYA -->
      ...
      <script>
        ...
        $('.delete').click(function () {
          ...
          swal({
            ...
            text: "Kamu akan menghapus data film dengan judul " + judul + "",
            icon: "warning",
            buttons: true,
            dangerMode: true,
          })
            .then((willDelete) => {
              if (willDelete) {
                window.location = "/hapusfilm/" + dataid + ""
